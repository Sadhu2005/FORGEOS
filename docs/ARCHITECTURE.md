...
**Runnable today:** Phase 0–6 CLI including memory (`forgeos memory status|decisions|sync`). See [PHASE6.md](PHASE6.md).
...
- [schemas/](schemas/) — world state / task / decision / role / memory schemas
